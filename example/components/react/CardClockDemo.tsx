...
/>`}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <h4 style={{ color: '#007acc', marginBottom: '8px' }}>⚙️ 配置说明</h4>
            <ul style={{ paddingLeft: '20px', color: '#555' }}>
              <li><strong>customDate</strong>: 自定义日期，支持 yyyy-mm-dd 和 YYYY-MM 格式</li>
              <li><strong>formatOptions</strong>: 控制显示哪些日期信息</li>
              <li><strong>theme</strong>: 主题样式选择</li>
              <li><strong>animated</strong>: 是否启用动画效果</li>
            </ul>
          </div>
          <div>
            ...
            <ul style={{ paddingLeft: '20px', color: '#555' }}>
              ...
              <li>导入组件：<code>import CardClock from './CardClock'</code></li>
              <li>基础使用：<code>&lt;CardClock /&gt;</code></li>
