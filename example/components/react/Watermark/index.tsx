...
export default function WatermarkDemo() {
	...
	const [activeTab, setActiveTab] = useState<'normal' | 'echarts'>('normal');

	return (
		<div className="w-full max-w-6xl mx-auto p-5">
			<div className="mb-6">
				<h2 className="text-2xl font-bold mb-4">水印组件演示</h2>
			...
			{activeTab === 'normal' ? (
				...
				<div className="border border-gray-200 rounded-lg bg-white overflow-hidden">
					<iframe
						src="/example/components/react/Watermark/echarts-example"
