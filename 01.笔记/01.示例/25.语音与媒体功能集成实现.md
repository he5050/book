...
这三个功能都依赖于现代浏览器的原生 API，兼容性如下：

- **文字转语音 (TTS)**: 支持 Chrome 33+, Firefox 49+, Edge 14+, Safari 7+
- **语音转文字 (STT)**: 支持 Chrome 25+, Edge 79+, Firefox 需要启用实验性功能
- **媒体录制**: 支持 Chrome 61+, Firefox 29+, Edge 79+, Safari 14.1+
